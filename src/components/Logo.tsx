...
function FallbackMark({ className }: { className?: string }) {
  return (
    <span
      className={cn(
        "relative block aspect-[1.08] overflow-hidden rounded-[4px] bg-[#030405]",
        className
      )}
      aria-hidden
    >
      <span className="absolute left-[16%] top-[9%] h-[24%] w-[72%] skew-x-[-28deg] bg-gradient-to-b from-white to-[#A7B0BE]" />
      <span className="absolute left-[16%] top-[38%] h-[20%] w-[55%] skew-x-[-28deg] bg-gradient-to-b from-[#F4F7FA] to-[#A7B0BE]" />
      <span className="absolute left-[16%] top-[66%] h-[18%] w-[68%] skew-x-[-28deg] bg-gradient-to-br from-[#1D6FFF] to-[#174FC2] shadow-[0_0_24px_rgba(29,111,255,0.45)]" />
  ...
  return (
    <span className="flex items-center gap-3">
      ...
      <span className="grid leading-none">
        <span className="text-xl font-semibold tracking-[0.28em] text-[#F4F7FA]">
          EPYK
        </span>
        <span className="mt-1 text-[0.7rem] font-semibold tracking-[0.62em] text-[#1D6FFF]">
          SYSTEMS
        </span>
      </span>
    </span>
    ...
    >
      {failed ? (
        ...
        <img
          ...
          className={cn(
            "block object-contain object-left transition duration-300 group-hover:drop-shadow-[0_0_16px_rgba(29,111,255,0.28)]",
