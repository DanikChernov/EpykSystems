...
export const assessmentBoundary =
  "Client understands this is not a cybersecurity audit, compliance certification, ERP implementation, or software build.";

export const assessmentScopeExclusions = [
  "The assessment covers one facility and one workflow domain.",
  "Additional facilities or workflow domains require separate scoping.",
  "Observations are limited to the agreed assessment window.",
  "Findings do not guarantee that every possible issue will be discovered.",
  "Implementation work is not included in the $3,500 assessment.",
  "Compliance, CMMC, NIST, CUI, ITAR, cybersecurity, legal, safety-certification, or regulatory-certification work is not implicitly included."
] as const;

export const assessmentEngagementSequence = [
  "Free initial intake",
  "Scope confirmation",
  "One onsite observation day",
  "Analysis and findings",
  "Client-facing findings report",
  "Prioritized remediation roadmap",
  "Optional separately scoped implementation"
] as const;
